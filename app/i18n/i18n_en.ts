...
const schema: PrepareSchema<LocalizationSchema, '' | '_plural'> = {
    ...
    newAddressFormat: {
        ...
        shortDescription: 'New address format avoids errors by incorrect transactions sending. You can change the format in the settings at any time.',
        ...
        description_1: 'We recommend changing the address format to the new one immediately to avoid discrepancies in the display with other services. The old address will continue to work in the same mode and will be linked to your wallet. You can always switch the address format in the settings. Your funds are safe.',
        action: 'Use {{format}}',
