...
const schema: PrepareSchema<LocalizationSchema, '' | '_plural'> = {
    ...
    newAddressFormat: {
        ...
        fragmentTitle: 'New address type',
        learnMore: 'More about new format',
        shortDescription: 'This type avoids errors by incorrect transactions sending. Old address will continue to work as before too. You can change type in the settings at any time.',
        description_0: 'Previously, wallet and contract addresses in TON were displayed in the same type, which in some cases led to incorrect transactions sending. With new type, developers can easily distinguish a wallet from a contract and avoid errors.',
        description_1: 'We recommend changing type to the new one immediately to avoid discrepancies in the display with other services. The old address will continue to work in the same mode and will be linked to your wallet. You can always switch type in the settings. Your funds are safe.',
        action: 'Use {{format}}',
