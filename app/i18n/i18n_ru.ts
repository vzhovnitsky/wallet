...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    "newAddressFormat": {
        ...
        "description_0": "Ранее адреса кошельков и контрактов в TON отображались в одинаковом формате, что в некоторых случаях приводило к некорректной отправке транзакций. В новом формате можно легко отличить кошелек от контракта и избежать ошибок.",
        "description_1": "Старый адрес продолжит работать в прежнем режиме и будет связан с тем же кошельком. Переключить формат всегда можно в настройках. Ваши средства остаются в безопасности.",
