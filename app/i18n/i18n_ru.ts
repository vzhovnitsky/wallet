...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    "newAddressFormat": {
        "title": "Формат адреса",
        "fragmentTitle": "Новый формат адреса",
        "learnMore": "Узнать больше",
        "shortDescription": "Новый адрес позволяет избежать ошибок при отправке транзакций. Вы сможете вернуться к старому формату в настройках в любое время.",
        "description_0": "Ранее адреса кошельков и контрактов в TON отображались одинкаково, что в некоторых случаях приводило к ошибкам в отправке транзакций. В новом формате легко отличить кошелек от контракта и избежать ошибок.",
        "description_1": "Мы рекомендуем сразу изменить формат адреса на новый, чтобы избежать расхождений в отображении с другими сервисами. Старый адрес продолжит работать в прежнем режиме и также будет привязан к вашему кошельку. Вы всегда можете переключить формат адреса в настройках. Ваши средства в безопасности.",
