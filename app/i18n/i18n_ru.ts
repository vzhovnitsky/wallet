...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    "newAddressFormat": {
        ...
        "fragmentTitle": "Новый формат отображения адреса кошелька",
        "description_0": "Новый формат избегает проблем с отправкой средств на неопубликованные адреса.",
        "description_1": "Старый адрес продолжит работать и связан с тем же кошельком, а ваши средства останутся в безопасности. Вы можете в любое время переключить адрес на старый формат или обратно в настройках приложения.",
